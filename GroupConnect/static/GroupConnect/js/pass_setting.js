...
$(function() {
    ...
    if ($("input[name='currentpass']").val() == '' && $("input[name='pass']").val() == '' && $("input[name='passconf']").val() == '') {
        ...
        return false;
    }else if ($("input[name='currentpass']").val() == '' && $("input[name='pass']").val() == '') {
        ...
        $('.passconfdifferent').hide();
        return false;
    }else if ($("input[name='currentpass']").val() == '' && $("input[name='passconf']").val() == '') {
        ...
        $('.passconfdifferent').hide();
        return false;
    } else if ($("input[name='currentpass']").val() == '') {
        //現在のパスワードが入力されていない場合
        $('.currentpassblank').show();
        $('.passblank').hide();
        $('.passconfblank').hide();
        ...
        $('.passconfdifferent').hide();
        return false;
    } else if (!$("input[name='currentpass']").val().match(/^[0-9a-zA-Z]{8,32}$/) && !$("input[name='pass']").val().match(/^[0-9a-zA-Z]{8,32}$/) && !$("input[name='passconf']").val().match(/^[0-9a-zA-Z]{8,32}$/)) {
        ...
        $('.passconfdifferent').hide();
        return false;
    } else if (!$("input[name='currentpass']").val().match(/^[0-9a-zA-Z]{8,32}$/) && !$("input[name='pass']").val().match(/^[0-9a-zA-Z]{8,32}$/)) {
        ...
        $('.passconfdifferent').hide();
        return false;
    } else if (!$("input[name='currentpass']").val().match(/^[0-9a-zA-Z]{8,32}$/) && !$("input[name='passconf']").val().match(/^[0-9a-zA-Z]{8,32}$/)) {
        ...
        $('.passconfdifferent').hide();
        return false;
    } else if (!$("input[name='currentpass']").val().match(/^[0-9a-zA-Z]{8,32}$/)) {
        //パスワードの文字数が違う場合
        $('.currentpassblank').hide();
        $('.passblank').hide();
        $('.passconfblank').hide();
