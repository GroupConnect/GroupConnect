# Generated by Django 2.2.dev20180717020843 on 2019-02-14 06:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attached_file', models.FileField(blank=True, db_column='file', null=True, upload_to='files/')),
                ...
                ('reply', models.ForeignKey(blank=True, db_column='reply', null=True, on_delete=django.db.models.deletion.CASCADE, to='GroupConnect.Post')),
            ],
        ),
        migrations.CreateModel(
            name='Talk',
