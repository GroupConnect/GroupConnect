...
urlpatterns = [
    ...
    path('group_top/(?P<id>[0-9]+)/group_setting/', views.GroupSet.as_view(), name='group_setting'),
    path('group_top/(?P<id>[0-9]+)/member_list/', views.MemberList.as_view(), name='member_list'),
    ...
    path('user_testmailaddress_update/<int:pk>/', views.UserTest2MailaddressUpdate.as_view(), name='user_test2mailaddress_update'),
